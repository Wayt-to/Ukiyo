<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPaneli/Admin.Master" AutoEventWireup="true" CodeBehind="ModeratorListesi.aspx.cs" Inherits="Ukiyo.AdminPaneli.ModeratorListesi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="formBaslik">Moderatörleri Listele <asp:Button ID="SearchButton" runat="server" Text="Ara" style="padding:8px;float:right;border-radius:20px;font-weight:600;" OnClick="SearchButton_Click" /><asp:TextBox ID="SearchBox" runat="server" placeholder="Moderatör Adı Giriniz" BorderStyle="Dashed" style="padding:8px;float:right;"></asp:TextBox></div>
    <div class="ayrac"></div>

    <div class="tabloDıs">
        <asp:ListView ID="lv_Modlar" runat="server" OnItemCommand="lv_Modlar_ItemCommand">
            <LayoutTemplate>
